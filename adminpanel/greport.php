...
$date3 = $date3->format('F d, Y');
    ...
    $sql = "SELECT * FROM orders WHERE date between '$date' and '$date2' AND status !=0";
    ...
    $sql2 = "SELECT SUM(total_amount)  AS sum from orders where date between '$date' and '$date2' and status!=0";
